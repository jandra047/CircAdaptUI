#include "rightventricle2.h"

QMap<QString, QString> RightVentricle2::namePath
{
...
RightVentricle2::RightVentricle2(SVGObjectBase* parent) :
...
void RightVentricle2::setSelected(bool isSelected)
{
    if (isSelected) {
        setZValue(10);
        selectAll();
